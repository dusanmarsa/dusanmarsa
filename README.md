...
- **[validvision](valid.vision)** — multi-persona AI panel that pressure-tests startup ideas. Built with Mastra workflows, web search via Exa, real-time streaming transcript in Next.js.
